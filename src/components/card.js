...
const Card = ({inputContent, setInputContent, onSignup, loading, type, onOtpVerify}) => {
	...
	return(
		<div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 shadow-lg my-28">
				<h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white underline">OTP Verification</h5>
				...
				<p className="mb-3 font-normal text-gray-700 dark:text-gray-400 my-5">An OTP will be send to your mobile number via SMS. Use it to verify your identity</p>
